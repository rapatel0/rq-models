...
| **Phase 2a kernel math** (parity test) | ⏸ pending GPU-box runtime | run `python3 scripts/sprint004_phase2_kernel_test.py` on the RTX 5090. Standalone — JIT-builds the kernel and runs L2-norm preservation + per-element relerr + zero-input safety + bpe invariant tests. |
