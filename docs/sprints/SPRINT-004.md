...
| **Phase 2c Qwen3.6 family probe** (Qwen3.6-27B kernel cos-sim) | ✅ 2026-04-26 | Downloaded `Qwen/Qwen3.6-27B` (55.6 GB bf16, 64 layers, 16 full-attn, head_dim=256, mrope-interleaved, partial RoPE 0.25). Architecturally `Qwen3_5ForConditionalGeneration` — Qwen3.6 inherits the Qwen3.5 model class scaled to 5120 hidden / 17 408 intermediate. Kernel probe at L03 / L35 / L63 full-attn layers: cos-sim mean **0.97 / 0.95 / 0.97** (k_norm), σ 1.18–1.54 — same well-conditioned signature as Qwen3.5-4B and Qwen3.5-9B, no Qwen3 L00 γ blow-up. **Phase 2c rq3 will work for Qwen3.6 family without recalibration.** Full end-to-end serve test is gated on vLLM v0.19.1's hybrid-attention + cpu-offload assertion (upstream PR #18298) — not an rq3 issue. Artifact: `SPRINT-004-PHASE2C-QWEN36-PROBE.md`. |
