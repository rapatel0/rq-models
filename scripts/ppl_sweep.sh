#!/bin/bash
# Perplexity sweep: imatrix variants of Qwen3.5-27B dense on wikitext-2
set -euo pipefail
...
RESULTS="/home/ravi/repos/turbo/docs/ppl_sweep_results.txt"

VARIANTS=(
  "unsloth/Qwen3.5-27B-GGUF|Qwen3.5-27B-UD-IQ2_XXS.gguf"
  "unsloth/Qwen3.5-27B-GGUF|Qwen3.5-27B-UD-IQ2_M.gguf"
  "unsloth/Qwen3.5-27B-GGUF|Qwen3.5-27B-UD-IQ3_XXS.gguf"
  "unsloth/Qwen3.5-27B-GGUF|Qwen3.5-27B-UD-Q3_K_XL.gguf"
  "unsloth/Qwen3.5-27B-GGUF|Qwen3.5-27B-IQ4_XS.gguf"
  "unsloth/Qwen3.5-27B-GGUF|Qwen3.5-27B-Q8_0.gguf"
)

echo "=================================================================="
echo "  Qwen3.5-27B Dense — Perplexity Sweep (imatrix variants)"
echo "  wikitext-2, ctx=2048"
echo "=================================================================="
echo ""

> "$RESULTS"
echo "# Qwen3.5-27B Dense PPL Sweep — $(date)" >> "$RESULTS"
echo "" >> "$RESULTS"
